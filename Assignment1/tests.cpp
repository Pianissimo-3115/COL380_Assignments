...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Time taken by sequential updateDisplay: " << duration.count() << " ms" << std::endl;
    t1 = std::chrono::high_resolution_clock::now();
    printOrderStats_seq(orderBook);
    t2 = std::chrono::high_resolution_clock::now();
    duration = t2 - t1;
    std::cout << "Time taken by sequential printOrderStats: " << duration.count() << " ms" << std::endl;
    t1 = std::chrono::high_resolution_clock::now();
    int64_t total = totalAmountTraded_seq(orderBook);
    // std::cout << "total amount traded is " << totalAmountTraded_seq(orderBook) << std::endl;
    t2 = std::chrono::high_resolution_clock::now();
    /*std::chrono::duration<double, std::milli>*/ duration = t2 - t1;
    std::cout << "total amount traded (sequential version) is " << total << std::endl;
    std::cout << "Time taken by sequential totalAmountTraded: " << duration.count() << " ms" << std::endl;
    ...
    std::cout << "Time taken by parallel updateDisplay: " << duration2.count() << " ms" << std::endl;
    ...
    duration2 = t4 - t3;
    std::cout << "Time taken by parallel printOrderStats: " << duration2.count() << " ms" << std::endl;
    t3 = std::chrono::high_resolution_clock::now();
    int64_t total2 = totalAmountTraded(orderBook);
    t4 = std::chrono::high_resolution_clock::now();
    /*std::chrono::duration<double, std::milli>*/ duration2 = t4 - t3;
    std::cout << "total amount traded (parallel version) is " << total2 <<  std::endl;
    std::cout << "Time taken by parallel totalAmountTraded: " << duration2.count() << " ms" << std::endl;
